						...
						<div id="yui-main">
							<div class="yui-b">
								<div class="yui-gf">
									...
									<div class="yui-u">
										<p class="enlarge">${instructorProfile.instructorName}</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="yui-main">
							<div class="yui-b">
								<div class="yui-gf">
									...
									<div class="yui-u">
										<p class="enlarge">${instructorProfile.designation}</p>
									</div>
								</div>
							</div>
						</div>
 ...
 -->
					<div id="bd">
						<div id="yui-main">
							...
							<!-- 		<div class="yui-u">
							 ...
							 -->		
								 <div class="yui-u">
										<p class="enlarge">${instructorProfile.coursesTaught}</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="yui-main">
							<div class="yui-b">
								...
								<div class="yui-gf">
									...
									<div class="yui-u">
										<p class="enlarge">${instructorProfile.timeAtSyracuse}</p>
									</div>
								</div>
							</div>
						</div>
		...
		<c:when test="${mode=='MODE_UPDATE_PRO' }">
			<div id="doc2" class="yui-t7">
				<div id="inner">
					<div class="profile_img">
						<form class="FORM" method="POST" action="instructor-profile-saved?id=${instructorProfile.id}">
								...
								<div id="yui-main">
									<div class="yui-b">
										<div class="yui-gf">
											...
											<div class="yui-u">
												<textarea name="designation" style="width: 100%; height: 100px">${instructorProfile.rank}</textarea>
